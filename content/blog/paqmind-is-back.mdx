...
The reason are typical and boring – work, family, lack of time... We were also splitting our efforts between
Russian and English content.

As of now we decided to keep blogging in English. Monolingual site is so much easier to develop, support, 
and advertise. And most engineers nowadays know English anyway. So :raised_hand: to all native and non-native 
speakers who read us, and let's continue with the main topic of the post. Namely – what changed in 
the industry in recent years.

## Web Dev in retrospective :amphora:

But I'd start earlier to see more context. Web Development has been booming for the third decade. 
